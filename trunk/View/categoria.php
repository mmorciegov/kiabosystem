...
<link rel="stylesheet" type="text/css" href="scripts/stilo_topo.css" />
...
<div id="GERAL">
	...
	<div id="TOPO"> <div id="logotipo"></div> 
<div class="tag_form_log">Usuário</div><input class="form_log" type="text" id="name" />
	  <div class="tag_form_senha">Senha</div>
      <input class="form_senha" type="password" id="senha" />
      <div class="botao_login"><input name="login" type="button" value="login" /></div>
        <div class="botao_login"><input name="login" type="button" value="login" /></div>
	</div><!--Fim do bloco #TOPO -->
  
    <!--Início do #MENU topo-->
    <ul id="MENU">
        <li><a><img src="imagens/home_icon.png" width="14" height="14" alt="home" /> Home</a></li>
        <li><a><img src="imagens/castro_icon.png" width="14" height="15" alt="cad" /> <a href="cadastro.php">Cadastre-se</a></a></li>
        <li><a><img src="imagens/log_icon.png" width="11" height="13" alt="login" /> Login</a></li>
        <li><a><img src="imagens/sac_img.png" width="13" height="13" alt="sac" />SAC</a></li>
    </ul> <!--Fim do #MENU -->
...
<div class="BUSCA">
    ...
    <div class="botao_busca"><input name="busca" type="button" value="Buscar" />
     <div class="carrinho"><a href="categoria.php"><img src="imagens/carrinho.png" width="135" height="45" alt="carrinho" /></a></div>
    </div>
...
<div id="CONTEUDO"> 
	...
	<div class="BARRA"><div class="MARCADOR_BARRA_CAT"></div></div> <!--Fim da Barra Lateral esquerda -->
        
        <div class="PROMOCOES"> <div class="PRODUTO"></div></div>
